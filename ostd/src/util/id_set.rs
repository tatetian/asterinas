...
//!
//! One use case of `IdSet<CpuId>` in OSTD is [`crate::cpu::set::CpuSet`],
//! which is in fact a thin wrapper around `IdSet<CpuId>`.
...
/// # Examples
///
/// Assume that you have a type named `CpuId` that represents valid CPU IDs.
///
/// ```
/// # use ostd::util::id_set::{Id, IdSet};
...
mod id_set_tests {
    ...
    #[ktest]
    fn test_id_set_add_remove_multi_part() {
    ...
    #[ktest]
    fn test_id_set_iter_multi_part() {
    ...
    #[ktest]
    fn test_id_set_cardinality_one() {
    ...
    #[ktest]
    fn test_id_set_exact_part_boundary() {
    ...
    #[ktest]
    fn test_id_set_just_over_part_boundary() {
    ...
    #[ktest]
    fn test_id_set_is_full_with_less_than_full_last_part() {
