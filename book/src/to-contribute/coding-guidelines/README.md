...
| General | Be accurate | [`accurate-names`](general-guidelines/README.md#accurate-names) |
...
| General | Prefer semantic line breaks | [`semantic-line-breaks`](general-guidelines/README.md#semantic-line-breaks) |
| General | Explain why, not what | [`explain-why`](general-guidelines/README.md#explain-why) |
...
| General | Group statements into logical paragraphs | [`logical-paragraphs`](general-guidelines/README.md#logical-paragraphs) |
| General | Format error messages consistently | [`error-message-format`](general-guidelines/README.md#error-message-format) |
| General | Stick to familiar conventions | [`familiar-conventions`](general-guidelines/README.md#familiar-conventions) |
