...
The prototype is five commits on top of `ab9a4cfdc`. They live on the branch
[`device-model`](https://github.com/tatetian/asterinas/tree/device-model) of a fork, and were
opened here as [#3846](https://github.com/asterinas/asterinas/pull/3846) and closed without merging, so that this
document can link to them from within this repository. Every listing below is such
a link, and the closing section lists the commits one by one.
...
[`kernel/core/comps/device`](https://github.com/asterinas/asterinas/tree/226e50c71da2dbc50d8fe2a1b3e92c742e46a5c8/kernel/core/comps/device).
...
[`device-model`](https://github.com/tatetian/asterinas/tree/device-model), opened here as the closed, unmerged
[#3846](https://github.com/asterinas/asterinas/pull/3846):

| Commit | What it does |
|---|---|
| [`b7a4b2992`](https://github.com/asterinas/asterinas/commit/b7a4b299246cf6e86142cc3cbdc569dc936b0c30) | `systree`: a node may replace its attribute set, and `relative_path` |
| [`4ad6aae04`](https://github.com/asterinas/asterinas/commit/4ad6aae04adc761fb3afb20618831bb3adb2e656) | sysfs: revalidate cached dentries against the live tree |
| [`7e9a1d4c7`](https://github.com/asterinas/asterinas/commit/7e9a1d4c7b101804b2f9f4291cf5b0022229e029) | the `aster-device` component itself, with its kernel-mode tests |
| [`226e50c71`](https://github.com/asterinas/asterinas/commit/226e50c71da2dbc50d8fe2a1b3e92c742e46a5c8) | the `mem` conversion and the kernel-side hooks |
